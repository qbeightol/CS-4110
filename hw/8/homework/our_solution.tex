...
By the inductive hypothesis, $\mathit{erase}(e\{v/x\}) = \mathit{erase}(e)\{v/x\}$. Therefore, our two expressions above are equal, which concludes this case. \checkmark\\

{\sc case} $e = e_1e_2$: TODO.\\

{\sc case context}: TODO.\\

{\sc case}: TODO: are there other cases?\\
